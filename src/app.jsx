...
export default function App() {
  ...
  const fetchLiveResults = async () => {
    try {
      ...
      for (const mApi of (data.matches || [])) {
        ...
        if (m) {
          ...
          if (m.goals1 !== g1 || m.goals2 !== g2 || m.status !== st) {
            updatePromises.push(updateMatch(m.id, { goals1: g1, goals2: g2, status: st, minute: mApi.minute?.toString() || null }));
          }
        }
      }
