            ...
            <div className="absolute top-full right-0 mt-2 w-72 bg-white rounded-2xl shadow-2xl border overflow-hidden z-50 animate-in slide-in-from-top-2">
              ...
              <div className="max-h-64 overflow-y-auto no-scrollbar">
                {activeUser?.notifications?.length > 0 ? activeUser.notifications.map((n, i) => (
                  <button type="button" key={n.id || i} onClick={() => {
                  ...
                  }} className={`w-full text-left p-4 border-b cursor-pointer transition-colors flex items-start gap-3 focus:outline-none focus:bg-indigo-50/50 ${n.isRead ? 'opacity-60 bg-white hover:bg-slate-50' : 'bg-indigo-50/30 hover:bg-indigo-50/50'}`}>
                    ...
                    <tbody className="divide-y">
                      {leaderboard.map(u => (
                        <tr key={u.id} className="hover:bg-indigo-50/50 transition-colors">
                          ...
                          <td className="p-0">
                            <button type="button" className="w-full h-full text-left font-bold cursor-pointer hover:text-indigo-600 transition-colors focus:ring-2 focus:ring-indigo-500/50 outline-none p-5" onClick={() => setSelectedUser(u)}>
